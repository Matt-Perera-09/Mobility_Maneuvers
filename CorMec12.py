...
while play_again:
    ...
    while menu_running:
        ...
        # --- Draws the menu text
        title_text = sys_font.render("Mobility Maneuvers: Hollering Halls!", True, white)
    ...
    replay_button = pygame.Rect(SCREEN_WIDTH // 2 - 210, SCREEN_HEIGHT - 70, 200, 50)
    replay_button_color = (255, 140, 0) # Light Orange 
    
    exit_button = pygame.Rect(SCREEN_WIDTH // 2 + 10, SCREEN_HEIGHT - 70, 200, 50)
    ...
    while end_running:
        ...
        # 3. Scoreboard name
        title_text = sys_font.render(f"#-# TOP 5 Fastest Runs #-#", True, (255, 160, 0)) # Gold
        ...
        if len(scores) == 0:
            ...
            screen.blit(empty_text, (SCREEN_WIDTH // 2 - empty_text.get_width() // 2, 330))
        else:
